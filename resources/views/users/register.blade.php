        ...
        <div class="container px-5 pt-12 mx-auto flex sm:flex-nowrap flex-wrap">
            ...
            <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                ...
                <div class="relative mb-4">
                    ...
                    <input type="password" id="password_confirmation" name="password_confirmation" class="w-full bg-white rounded border border-gray-300 focus:border-pink-500 focus:ring-2 focus:ring-pink-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                </div>
                ...
                <p class="text-xs text-gray-500 mt-3 text-center">Already have an account? <a href="/login"><span class="text-pink-500">Login here.</span></p></a>
            </div>
        </div>
    </section>
</form>
